...
static char * const rcsid = "$Id: Database.xs,v 1.1 2000/05/22 08:38:33 rjray Exp $";
...
extern SV* rpmhdr_FETCH(RPM__Header, SV *, const char *, int, int);
...
int rpmdb_FIRSTKEY(RPM__Database self, SV** key, RPM__Header* value)
{
    ...
    *key = rpmhdr_FETCH(*value, newSVpv("name", 4), Nullch, 0, 0);
                  ...
                  SV** nextkey, RPM__Header* nextvalue)
{
    ...
    *nextkey = rpmhdr_FETCH(*nextvalue, newSVpv("name", 4), Nullch, 0, 0);
